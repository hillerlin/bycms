<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\workspace\bycms/application/index\view\model\document_detail.html";i:1504697179;s:60:"E:\workspace\bycms/application/index\view\public\header.html";i:1504516971;s:60:"E:\workspace\bycms/application/index\view\public\footer.html";i:1504516707;}*/ ?>
...
<div class="mcenter clear">
  <div class="list_left fl">
    <div class="nav">当前位置：<a href="">大麦理财</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="">资讯中心</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="">行业资讯</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="">新闻标题新闻标题</a></div>
    <div class="list_main">
      <div class="ct"><img src="http://cdn1.damailicai.com/news/05.png" alt=""></div>
      <h2 class="news_title">新闻标题新闻标题</h2>
			<div class="news_mark">
      ...
      <div class="abstract">在2015年全国银行业监督管理工作会议上，银监会主席尚福林就盘活存量、加快林就盘活存量、加快信贷资产证券化常规化发展时，特别强调“要以新设立的银行信贷资产流转中心为主体”。</div>
      <div class="news_detail">
				<p>金融资产交易国家队来了。</p>
				<p>据知情人士透露，在2015年全国银行业监督管理工作会议上，银监会主席尚福林就盘活存量、加快信贷资产证券化常规化发展时，特别强调“要以新设立的银行信贷资产流转中心为主体”。该人士并提及，该中心登记流转的资产并不会局限于信贷资产、信贷资产证券化产品，银行业的非标资产、网络借贷(P2P)资产均可能纳入该流转平台，未来可能成为金融资产交易平台中的国家队。</p>
				<img src="http://cdn1.damailicai.com/news/06.png" alt="">
				<p>澎湃新闻查询也发现，银行信贷资产流转中心目前已经公司化运作，全称为银行业信贷资产登记流转中心有限公司(以下简称“信贷资产流转中心”)。该公司注册于2014年6月，注册资本为3.5亿元，股东为中央国债登记结算有限责任公司(下称“中债登”)和中国农村金融杂志社，注册地为北京市丰台区丽泽路18号院1号楼金唐国际金融大厦。信贷资产流转中心法人代表、董事长为吕世蕴，水汝庆兼任董事和总裁，这两人分别是中债登董事长和总经理。</p>
				<p>简单理解，信贷资产登记流转中心的交易品种不仅限于银行贷款，可能做的事情会很多，澎湃新闻查询到该公司的2015年招聘资料亦印证了这一点。该公司目前与中债登招聘一并进行，招聘岗位包括两类，一是金融业务类，岗位职责包括非标产品登记、结算，创新产品交易监测、市场推广等，第二类是信息技术类，岗位职责为P2P业务信息监测与管理。</p>

      </div>
      <div class="news_marks">
				<label>标签：</label>
				<a href="" target="_blank">借贷</a>
				<a href="" target="_blank">循环借贷</a>
				<a href="" target="_blank">资金</a>
			</div>
			<div class="share">
				
			</div>
			<div class="prev_next clear">
				<a href="" class="prev fl" target="_blank"><b>上一篇：</b>新闻标题新闻标题</a>
				<a href="" class="next fr" target="_blank"><b>下一篇：</b>新闻标题新闻标题</a>
			</div>
    </div>
    ...
    <div class="statement">
			<h2>免责声明</h2>
			<p>本网转载并注明自其它来源的作品，目的在于传递更多信息，并不代表本网赞同其观点或证实其内容的真实性，不承担此类作品侵权行为的直接责任及连带责任。其他媒体、网站或个人从本网转载时，必须保留本网注明的作品来源，并自负版权等法律责任。 如涉及作品内容、版权等问题，请在作品发表之日起一周内与本网联系，否则视为放弃相关权利。</p>
    </div>
  </div>
