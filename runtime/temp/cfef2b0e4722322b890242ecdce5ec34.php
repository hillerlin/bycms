<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\wamp\www\bycms/application/install\view\index\complete.html";i:1501570685;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
    ...
    <p>安装完成！</p>
		    ...
		    <div class="btn_group">
		    	...
		    	<div class="agree">  <a  href="<?php echo $INSTALL_PATH; ?>admin.php">登录后台</a></div>
		    	<div class="not_agree agree"> <a href="<?php echo $INSTALL_PATH; ?>">访问首页</a></div>
		    </div>
		</div>
	</body>
</html>
