<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\wamp\www\bycms/application/admin\view\document\edit.html";i:1504514634;s:60:"D:\wamp\www\bycms/application/admin\view\public\sidebar.html";i:1501558248;s:59:"D:\wamp\www\bycms/application/admin\view\public\footer.html";i:1501271148;}*/ ?>
 <!-- 头部 -->
	<!DOCTYPE html>
<html>
	<head>
 ...
 <div class="edit_content_tab <?php if($k == 1): ?>none<?php endif; ?>">
  ...
  <div class="input_title">推荐位<span>(文章的推荐位，头条推荐必须有封面图)</span></div>
						  	 ...
						  	 <select name="position" >
								...
								<?php break; case "date": ?>
  				  <div class="input_title"><?php echo $vo['title']; ?><span>(<?php echo $vo['remark']; ?>)</span></div>
							<input type="text" name="create_time" id="create_time" class="laydate-icon input_box" value="<?php if(!(empty($info['id']) || (($info['id'] instanceof \think\Collection || $info['id'] instanceof \think\Paginator ) && $info['id']->isEmpty()))): ?><?php echo time_format($info[$vo['name']]); endif; ?>"/>
...
laydate({
  ...
  event: 'focus' //响应事件。如果没有传入event，则按照默认的click
						...
						<input type="text" name="description" class="input_box" value="<?php echo (isset($info['description']) && ($info['description'] !== '')?$info['description']:""); ?>"/>
						<div class="btn_group"> 
